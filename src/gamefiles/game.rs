...
pub fn game_loop(name: String) {
    ...
    loop {
        ...
        println!(
            "In front of you are three doors, one of them kills you. Which one do you choose? Enter a number between 1 and 3."
        );
        debug!("Generating deathly door");
    ...
    debug!("Checking Score if adding to scoreboard is needed");
    if score > 0 {
